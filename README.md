...
- `m3u8-downloader-0.3.1-windows-x64.exe`
- `m3u8-downloader-0.3.1-windows-x64.msi`
...
```bash
packaging/linux/build_deb.sh 0.3.1
```

发布 Windows、Android 和 Linux 资产时，可以在 GitHub Actions 中手动运行 `Release` workflow，并填写 tag，例如 `v0.3.1`。
...
- `m3u8-downloader_0.3.1_amd64.deb`
- `m3u8-downloader-0.3.1-windows-x64.exe`
- `m3u8-downloader-0.3.1-windows-x64.msi`
